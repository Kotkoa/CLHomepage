  ...
  return (
    <div id="focus" className="w-full px-4 text-white lg:px-[120px]">
      <div className="mt-32 flex flex-col items-start lg:mt-44 lg:items-center">
        <h1 className="mb-3 text-2xl leading-8 font-bold uppercase lg:mb-7 lg:text-[40px]">
          Where we focus
        </h1>
      ...
      <div className="flex flex-wrap items-center justify-around lg:justify-between">
        {focusTags.map((tag) => {
          return (
            <div
              key={tag.header}
              className="mb-6 flex w-80 flex-col items-center border border-white/5 bg-[#2A0808] px-10 pt-8 pb-6 lg:mb-10 lg:h-[590px] lg:w-[calc(50%-20px)] lg:max-w-[580px] lg:pt-12 lg:pb-14"
            >
              <img
                src={tag.logo}
                alt={tag.header}
              ...
              />
              <h1 className="text-center text-base leading-6 font-bold uppercase lg:text-[22px] lg:leading-7">
                {tag.header}
              </h1>
